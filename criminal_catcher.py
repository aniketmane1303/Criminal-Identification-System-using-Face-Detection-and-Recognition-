...
new_face_button = Button(root ,text = "Criminal Registration",
...
recognizer_button = Button(root ,text = "CRIMINAL FACE RECOGNITION",
                           command = recognition,
                           activeforeground = "#ffffff",
                           activebackground = "#168900",
                           padx=10,
...
image = Image.open('Criminal_wallpaper.jpg')
